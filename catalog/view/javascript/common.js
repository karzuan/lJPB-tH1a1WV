...
function display(view) {
	if (view == 'list') {
		...
		$('.product-list > div').each(function(index, element) {
			...
			html += '<div class="left-block col-xs-12 col-sm-3 col-md-3"><div class="image"><div class="image-product">' + $(element).find('.image .image-product').html() + '</div></div></div>';
			html += '<div class="right-block col-xs-12 col-sm-9 col-md-9"><div class="caption">';
		...
		$('.product-grid > div').each(function(index, element) {
			...
			html += '<div class="image-product">' + $(element).find('.image .image-product').html() + '</div>';
			html += '<div class="actions">' + $(element).find('.actions').html() + '</div>';
			html +='</div></div>';
			html += '<div class="right-block"><div class="caption"><div class="box-view-actions">';
